...
label_rects_2 = [surf.get_rect(topleft=(image_rect_2.right + label_offset, image_rect_2.top + i * font_10.get_height())) for i, surf in enumerate(label_surfaces_2)]
...
image_rect_3 = image_3.get_rect(topleft=(730, (screen_height - image_3_height) // 2 + 200))  
...
label_rects_3 = [surf.get_rect(topleft=(image_rect_3.right + label_offset, image_rect_3.top + i * font_10.get_height())) for i, surf in enumerate(label_surfaces_3)]
